...
SECRET_KEY = 'django-insecure-1f$ep!vz_&d3r%%!(!%#2o$0!pz5nbz914+!(^=(ynjb_=_hwd'
...
ROOT_URLCONF = 'evenup_project.urls'
...
WSGI_APPLICATION = 'evenup_project.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        # Optional: for persistent connections, which is good practice with cloud DBs
        conn_max_age=600,
    )
}
